...
5. 「Claudeに解説してもらう」の `<script>`：問題の画像（文章・図も含む）を canvas で1枚にまとめ、共有メニューで渡す（共有できないときは画像を保存して質問文をコピー）
...
- 次の機能が今までどおり動くこと：周回、苦手、計算用紙、「Claudeに解説してもらう」、バックアップの書き出しと読み込み。
...
4. 周回・苦手・計算用紙・Claude解説・バックアップの書き出しと読み込みを一通り操作する。
